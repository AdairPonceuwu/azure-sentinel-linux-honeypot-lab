...
| File | Purpose |
|---|---|
| [ssh-attack-map-workbook.json](ssh-attack-map-workbook.json) | Map visualization for SSH authentication attempts against the Debian honeypot |
...
6. Paste the JSON from [`ssh-attack-map-workbook.json`](ssh-attack-map-workbook.json).
